...
<%
    ...
    PessoaFisica pessoa = new PessoaFisica(nome);
    ControllerPessoaFisica controller = new ControllerPessoaFisica();
    List<PessoaFisica> pessoas = controller.listar(pessoa);
...
<html>
    ...
    <body>
        <table class="striped responsive-table">
            ...
            <% if (!(pessoas.isEmpty())) { %>    
                <tbody>
                    <% for (PessoaFisica listaPessoas : pessoas) { %>
                        <tr>
                            <td><%=listaPessoas.getId()%></td>
                            <td><%=listaPessoas.getNome()%></td>
                            <td><%=listaPessoas.getRg()%></td>
